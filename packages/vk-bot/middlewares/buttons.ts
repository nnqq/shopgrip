...
С помощью бота ShopGrip ты можешь отслеживать снижение цены на интересующий товар в интернет-магазине. Сейчас бот поддерживает большинство популярных интернет-магазинов России и список постоянно расширяется

Просто отправь ссылку на товар, и бот добавит этот товар в твой список отслеживания. С этого момента, бот будет пристально следить на ценой товара, и как только она уменьшится, заботливо пришлет тебе сообщение об этом
...
Попросить добавить твой любимый интернет-магазин и написать все, что ты думаешь о боте, можно в обсуждении: ССЫЛКА_НА_ОБСУЖДЕНИЕ`, null, menuButtons);
    }
